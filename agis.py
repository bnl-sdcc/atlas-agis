...
PQFILTERREQMAP = { 'pilot_manager' : ['harvester'],
                   'resource_type' : ['grid'],
                   'site_state' : ['active']
                   } 
PQFILTERNEGMAP = { } 
...
#
    ...
    def getAPFConfigString(self, volist=None, cloudlist=None, activitylist=None, defaultsfiles=None):
        self._updateInfo()
        self._createAPFConfig()
...
if __name__ == '__main__':
    ...
    if fconfig_file is not None:
        ...
        vos = atlas
        clouds = US
        ativities = analysis,production
        defaultsfiles = /etc/autopyfactory/agisdefaults.conf
        """
    ...
    if pilotmanager is not None:
        fconfig.set('Factory', 'config.queues.agis.pilotmanager', pilotmanager)
